                            ...
                            <div className="w-full flex flex-row flex-wrap justify-center gap-5">
                                <div className="flex px-8 items-center border border-gray-200 rounded dark:border-gray-700">
                                    <input
                                        ...
                                        id="bordered-radio-1" type="radio" value="admin" name="bordered-radio" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                    />
                                ...
                                <div className="flex px-8  items-center border border-gray-200 rounded dark:border-gray-700">
                                    <input
                                        onChange={(e)=>setType(e.target.value)} 
                                        id="bordered-radio-2" type="radio" value="parker" name="bordered-radio" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                    />
